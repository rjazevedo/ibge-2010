...
def names(opcao):
   ...
   if opcao == 9:       
      names = ['OndeTrabalhamAsPessoasDeCadaCursoDoCenso.xlsx','10Porcent_DF.csv','10Porcent_DF_Limpo.csv', '10Porcent_DF_Fem.csv', '10Porcent_DF_Masc.csv','10Porcent_DF_Fem_Limpo.csv', '10Porcent_DF_Masc_Limpo.csv','Kmeans3_T.csv','100Porcent_DF_Fem.csv','100Porcent_DF_Masc.csv','100Porcent_DF_Fem_Limpo.csv','100Porcent_DF_Masc_Limpo.csv','Resultados_T_Fem_Masc_Kmeans3_Genero.csv','Resultados_T_Filtrados_Kmeans3_T.csv','Resultados_T_29_30-39_40-49_50-59_60Kmeans3_Idade.csv','Resultados_T_Filtrados_Kmeans3_T_Preenchido_Cluster2.csv','Resultados_T_Filtrados_Kmeans3_T_Preenchido_Cluster1.csv','Resultados_T_Filtrados_Kmeans3_T_Preenchido_Cluster0.csv']       
   if opcao == 10:       
