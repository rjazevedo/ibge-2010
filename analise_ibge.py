...
#if fase >= 0:
if fase == 0:
   ibge_functions_split.ibge_download() 
   pass    
...
#if fase >= 1:
if fase == 1:
   ibge_functions_split.ibge_filter()
   pass
...
if fase == 2:
   ...
   #ibge_functions_split.ibge_Graduados_NaoGraduados()

   #ibge_functions_split.ibge_Pivot_Feminino()

   #ibge_functions_split.ibge_Pivot_Masculino()

   #ibge_functions_split.ibge_Pivot_Geral()        

   #ibge_functions_split.ibge_PivotTableFinal()

   #ibge_functions_split.ibge_PivotTableFinalB() 

   #ibge_functions_split.ibge_Graduados()
 
   ibge_functions_split.ibge_JuntarCSVs()      
pass      
